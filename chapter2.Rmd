...
- Gender is unbalaned, more females were sampled. 
- The age of male respondents has wider range.
- Possible linear relationship between points and attitude.
- Possible non linear relatonship between points and stra.
...
- Normality of the errors - There's deviation from the line, making errors not entirely normally distributed.
- Constant varaince of errors - size of residuals slightly decreases towards the end as fitted values increase.
